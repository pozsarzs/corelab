...
`TCommand` is the abstract base class for commands executed by the command
engine. It stores the command action name, parameter-count limits, execution
state and command scope. Descendant classes implement the abstract `Execute`
method.
