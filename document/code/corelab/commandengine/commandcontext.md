...
`TCommandContext` is the base context object used by the command engine to
store named constants and variables and to provide command output. Values are
stored in a dictionary using case-insensitive keys.
