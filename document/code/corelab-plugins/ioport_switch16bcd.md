...
## TSwitch16BCD from TGIOPort class in ioport_switch16bcd unit

One switch can be pressed at a time, the value of which can be read in BCD format.
...
|0|Returns the index of a pressed switch as `y * 4 + x`. Other ports return `FFh`.|
