...
One button can be pressed at a time, the value of which can be read in BCD format.
...
|0|Returns the index of the pressed button as `y * 4 + x` and then releases all buttons. Other ports return `FFh`.|
