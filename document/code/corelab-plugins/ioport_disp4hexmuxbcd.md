...
## TDisp4HexMUXBCD from TGIOPort class in ioport_disp4hexmuxbcd unit

TDisp4HexMUXBCD is a module that simulates a display peripheral derived from the
class TGIOPort and TDisplayTIL311. It has its own graphical user interface, which
contents a 4-digit multiplexed hexadecimal TIL311 style display with BCD input
