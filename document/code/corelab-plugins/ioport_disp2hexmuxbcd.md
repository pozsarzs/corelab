...
## TDisp2HexMUXBCD class

TDisp2HexMUXBCD is a module that simulates a display peripheral derived from the
class TGIOPort and TDisplayTIL311. It has its own graphical user interface, which
contents a 2-digit multiplexed hexadecimal TIL311 style display with BCD input
