...
|modsynhighlighterany*|SynHighlighterAny unit|(C) 1999 Martin Waldenburg                        |MPL v1.1 or GPL v2.0 or later|

**Note:**  
  The asterisk indicates that the external module has been modified. The
  difference is contained in the .diff file in its directory.
