...
type
  ...
  const
    ...
    SEKeyWords: array[0..91] of string = (
    ...
    'RSPU', 'RST',  'RUN',  'RUSC', 'RWIO', 'SESC', 'SHBL', 'SHBM', 'SHHV',
    'SHIL', 'SHIO', 'SHME', 'SHRL', 'SHRV', 'SHSC', 'SHSE', 'STEP', 'STOP',
    'STSC', 'SVME', 'SVPR', 'SVSC', 'SVSS', 'ADD',  'AND',  'BIT',  'CALL',
    'COMP', 'CONV', 'DEC',  'DEPO',  'END',  'EXAM', 'EXIT', 'HELP', 'INC',
    'INRG', 'JPEQ', 'JPZR', 'JPGE', 'JPGT', 'JPLE', 'JPLT', 'JPNE', 'JPNZ',
    'MUL',  'NOT',  'OR',   'PRNT', 'RTRN', 'SHL',  'SHR',  'SUB',  'SWAP',
    'WAIT', 'XOR');
var
  Form6: TForm6;
