...
// READ VIRTUAL PORT
function TDisp8HexMUXBCD.ReadPort(Port: byte): byte;
begin
...
// WRITE VIRTUAL PORT
procedure TDisp8HexMUXBCD.WritePort(Port: byte; Value: byte);
begin
  case Port of
...
begin
  if Assigned(Port) and (Port is TDisp8HexMUXBCD) then
    TDisp8HexMUXBCD(Port).CreatePanel;
end;
