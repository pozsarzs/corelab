...
procedure TLEDGreen8.PaintBoxPaint(Sender: TObject);
var
  b: Byte;
begin
...
// CREATE TLEDGREEN8 INSTANCE
constructor TLEDGreen8.Create;
var
  b: Byte;
begin
  inherited Create;
  FModname := '8-LED output';
  FDescription := 'This is an output with green LEDs, each bit controls a specific LED within a Byte.';
  FAddressRangeSize:= 1;
  FHasPanel := true;
  FLatchedOutput := true;
  for b := 0 to MAXX do
...
// DESTROY TLEDGREEN8 INSTANCE
destructor TLEDGreen8.Destroy;
var
  b: Byte;
begin
...
// READ VIRTUAL PORT
function TLEDGreen8.ReadPort(APort: Word): Byte;
begin
...
// LOAD SAVED STATE
function TLEDGreen8.LoadState(AStream: TStream): Boolean;
begin
...
// SAVE ACTUAL STATE
function TLEDGreen8.SaveState(AStream: TStream): Boolean;
begin
...
// CREATE PANEL
procedure TLEDGreen8.CreatePanel;
begin
...
begin
  if Assigned(APort) and (APort is TLEDGreen8)
    then TLEDGreen8(APort).CreatePanel;
end;
