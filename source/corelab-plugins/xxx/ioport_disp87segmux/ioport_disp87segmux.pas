...
begin
  inherited Create;
  s := '8 pcs. 7 segments multiplexed display';
  FModname := PChar(s);
  s := 'TIL302 style display; A0: direct inversable input, A1: select.';
...
begin
  ...
  PaintBox.OnPaint := @TDisp87segMux(Port).PaintBoxPaint;
