...
" instructions:
syn keyword corelabStatement ATIO ATME ATPU CRIO CFIO CFME CFPU CHWD CRME CRPU DIIO DIME DIPU DSIO DSME DSPU DTIO DTME DTPU EDME ENIO ENME ENPU EXAP IRQ LDME LDPR LDSC LDSS NMI NWPR NWSC RNIO RSAP RSIO RSME RSPU RST RUN RUSC SESC SHBL SHBM SHHV SHIL SHIO SHME SHRL SHRV SHSC SHSE STEP STOP STSC SVME SVPR SVSC SVSS ADD AND BIT CALL COMP CONV DEC DEPO END EXAM EXIT HELP INC INRG JPEQ JPZR JPGE JPGT JPLE JPLT JPNE JPNZ MUL NOT OR PRNT RTRN SHL SHR SUB SWAP WAIT XOR
